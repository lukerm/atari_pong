...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        """
        interp_epsilon = (1 - t / self.nsteps) * self.eps_begin + t / self.nsteps * self.eps_end
        self.epsilon = self.eps_end if t > self.nsteps else interp_epsilon
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        TODO: with probability self.epsilon, return a random action
                ...
                a random action        
        """
        return self.env.action_space.sample() if np.random.uniform(0, 1) < self.epsilon else best_action
